...
\begin{prop*}{}
Suponha que para algum $t_0 \in [a,b]$ vale que $\lim_{t \rightarrow t_0} f(x,t) = f(x,t_0)$. Se existe $g \in L(X, \mathcal{F}, \mu)$ tal que $|f(x,t)| \le g(x)$, $\forall (x,t) \in X \times [a,b]$, então
...
\begin{corollary*}{}
Se $f(x, \cdot)$ é contínua em $[a,b]$, para todo $x \in X$, e existe $g \in L(X, \mathcal{F}, \mu)$ tal que $|f(x,t)| \le g(x)$, então a função $F: [a,b] \rightarrow \mathbb{R}$ dada por
$$ F(t) = \int f(x,t) \, d\mu $$
é contínua.
\end{corollary*}

\begin{prop*}{}
Suponha que para algum $t_0 \in [a,b]$, $f(\cdot, t_0) \in L(X, \mathcal{F}, \mu)$, que $\frac{\partial f}{\partial t}$ existe em $X \times [a,b]$ e que existe $g \in L(X, \mathcal{F}, \mu)$ tal que
...
Portanto, $f(\cdot, t)$ é integrável para cada $t \in [a,b]$. Em particular, $h_n \in L(X, \mathcal{F}, \mu)$. 
...
\begin{prop*}{}
Se $f(x, \cdot)$ é contínua em $[a,b]$, para todo $x \in X$, e existe $g \in L(X, \mathcal{F}, \mu)$ tal que $|f(x,t)| \le g(x)$, então
...
\begin{prop*}{}
Seja $f: [a, +\infty) \rightarrow \mathbb{R}$ uma função tal que para cada $b > a$, $f$ é limitada e Riemann integrável em $[a,b]$. Se $f \in L([a, +\infty), \mathcal{M}, m)$ (ou seja, $f$ é integrável), então
