...
De maneira análoga, temos $\overline{\mathbb R} \in \mathcal C$. Agora, seja $A \in C$, 
  e note que da definição de $\mathcal C$, existem $M \in \borelR$ e 
  $N \subseteq \mcal P(\{-\infty, +\infty\})$ tal que $A = M \cup N$. Desse modo, 
  se $M^C = \overline R \setminus M$ e $N^C = \overline R \setminus N$,
  \begin{align*}
    A^C &= \xbR \setminus A = \xbR \setminus \parth{M \cup N}
    = \parth{\bR \cup \{-\infty, +\infty\}} \setminus \parth{M \cup N}\\
    &= \parth{\bR \cup \{-\infty, +\infty\}} \cap \parth{M^C \cap N^C}\\
    &= \cparth{\bR \cap \parth{M^C \cap N^C}} \cup 
    \cparth{\{-\infty, +\infty\} \cap \parth{M^C \cap N^C}}\\
    &= \parth{\bR \cap M^C} \cup \parth{\set{-\infty, +\infty} \cap N^C}.
  \end{align*}
  Visto que $\bR \cap M^C \in \borelR$ e 
  $\parth{\set{-\infty, +\infty} \cap N^C} \subseteq \mcal P \parth{\set{-\infty, +\infty}}$, 
  segue que $A^C \in \mcal C$.
